...
INSERT INTO `stu_wk`
VALUES
    (1,30001,'学生A',60001,'教师A','完成前端设计','2023-07-04 00:00:00','2023-07-09 00:00:00','分配','未通过','./',NULL,'正常完成前端任务'),
    (2,30001,'学生A',60001,'教师A','完成后端设计','2023-07-04 00:00:00','2023-07-09 00:00:00','未分配','未通过','./',NULL,'正常完成后端任务'),
    (3,30001,'学生A',60001,'教师A','完成大文档编写','2023-07-04 20:13:19','2023-07-09 20:13:19','分配','未通过','./',NULL,'正常完成文档任务'),
    (4,30002,'学生B',60001,'教师A','完成小文档设计','2023-07-04 20:13:19','2023-07-09 20:13:19','分配','通过','./',NULL,'正常完成任务'),
    (5,30002,'学生B',60001,'教师A','完成项目计划设计','2023-07-04 20:13:19','2023-07-09 20:13:19','分配','通过','./',NULL,'正常完成项目计划任务'),
    (6,30003,'学生C',60001,'教师A','完成后端详细分析','2023-07-04 20:13:19','2023-07-09 20:13:19','未分配','未通过','./',NULL,'正常完成后端详细分析'),
    (7,30004,'学生D',60001,'教师A','制定任务计划','2023-07-04 20:13:19','2023-07-09 20:13:19','分配','未通过','./',NULL,'正常完成计划指定'),
    (8,30005,'学生E',60001,'教师A','完成任务计划','2023-07-04 20:13:19','2023-07-09 20:13:19','分配','通过','./',NULL,'正常完完成计划指定'),
    (9,30005,'学生E',60001,'教师A','完成前端设计','2023-07-04 20:13:19','2023-07-09 20:13:19','分配','通过','./',NULL,'正常完成前端任务'),
    (10,30005,'学生E',60001,'教师A','完成后端设计','2023-07-04 20:13:19','2023-07-09 20:13:19','未分配','未通过','./',NULL,'正常完成后端任务'),
    (11,30005,'学生E',60001,'教师A','完成大文档编写','2023-07-04 20:13:19','2023-07-09 20:13:19','分配','未通过','./',NULL,'正常完成文档任务'),
    (12,30006,'学生F',60001,'教师A','完成前端设计','2023-07-04 20:13:19','2023-07-09 20:13:19','分配','通过','./',NULL,'正常完成前端设计'),
    (13,30007,'学生G',60007,'教师G','完成UI设计','2023-07-16 00:00:00','2023-07-21 00:00:00','未分配','未通过','/profile/upload/2023/07/07/组号4组长2019246需求分析_20230707224336A001.docx','/profile/upload/2023/07/08/user_1688729496074_20230708000205A001.xlsx','未完成UI设计任务'),
    (14,30007,'学生G',60007,'教师G','完成系统集成','2023-07-17 16:45:00','2023-07-22 16:45:00','分配','未通过','./',NULL,'正常完成系统集成任务'),
    (15,30007,'学生G',60007,'教师G','完成性能优化','2023-07-18 11:20:00','2023-07-23 11:20:00','分配','通过','./',NULL,'正常完成性能优化任务'),
    (16,30007,'学生G',60007,'教师G','完成用户反馈收集','2023-07-19 19:10:00','2023-07-24 19:10:00','未分配','未通过','./',NULL,'未完成用户反馈收集任务'),
    (17,30007,'学生G',60007,'教师G','完成安全测试','2023-07-20 10:30:00','2023-07-25 10:30:00','分配','通过','./',NULL,'正常完成安全测试任务'),
    (21,30007,'学生G',60007,'教师G','完成系统评估','2023-07-24 13:10:00','2023-07-29 13:10:00','分配','通过','./',NULL,'正常完成系统评估任务'),
    (22,30007,'学生G',60007,'教师G','完成用户验收','2023-07-25 18:25:00','2023-07-30 18:25:00','未分配','未通过','./',NULL,'未完成用户验收任务'),
    (23,30007,'学生G',60007,'教师G','完成项目总结','2023-07-26 12:40:00','2023-07-31 12:40:00','分配','通过','./',NULL,'正常完成项目总结任务'),
    (24,30007,'学生G',60007,'教师G','完成部署与上线','2023-07-27 14:55:00','2023-08-01 14:55:00','分配','通过','./',NULL,'正常完成部署与上线任务'),
    (25,30007,'学生G',60007,'教师G','完成需求变更','2023-07-28 10:10:00','2023-08-02 10:10:00','未分配','未通过','./',NULL,'未完成需求变更任务'),
    (26,30007,'学生G',60007,'教师G','完成数据备份','2023-07-29 18:35:00','2023-08-03 18:35:00','分配','通过','./',NULL,'正常完成数据备份任务');
...
VALUES
    (1,'主框架页-默认皮肤样式名称','sys.index.skinName','skin-red','Y','admin','2023-06-30 11:55:17','admin','2023-07-01 10:57:25','蓝色 skin-blue、绿色 skin-green、紫色 skin-purple、红色 skin-red、黄色 skin-yellow'),
    (2,'用户管理-账号初始密码','sys.user.initPassword','123456','Y','admin','2023-06-30 11:55:17','',NULL,'初始化密码 123456'),
    (3,'主框架页-侧边栏主题','sys.index.sideTheme','theme-light','Y','admin','2023-06-30 11:55:17','admin','2023-07-01 10:57:10','深色主题theme-dark，浅色主题theme-light'),
    (4,'账号自助-验证码开关','sys.account.captchaEnabled','true','Y','admin','2023-06-30 11:55:17','',NULL,'是否开启验证码功能（true开启，false关闭）'),
    (5,'账号自助-是否开启用户注册功能','sys.account.registerUser','false','Y','admin','2023-06-30 11:55:17','',NULL,'是否开启注册用户功能（true开启，false关闭）'),
    (6,'用户登录-黑名单列表','sys.login.blackIPList','','Y','admin','2023-06-30 11:55:17','',NULL,'设置登录IP黑名单限制，多个匹配项以;分隔，支持匹配（*通配、网段）');
...
(1, '系统管理', 0, 1, 'system', NULL, '', 1, 0, 'M', '0', '0', '', 'system', 'admin', '2023-06-30 11:55:17', '', NULL, '系统管理目录'),
(2, '系统监控', 0, 2, 'monitor', NULL, '', 1, 0, 'M', '0', '0', '', 'monitor', 'admin', '2023-06-30 11:55:17', '', NULL, '系统监控目录'),
(3, '系统工具', 0, 3, 'tool', NULL, '', 1, 0, 'M', '0', '0', '', 'tool', 'admin', '2023-06-30 11:55:17', '', NULL, '系统工具目录'),
(4, '若依官网', 0, 5, 'http://ruoyi.vip', NULL, '', 0, 0, 'M', '0', '0', '', 'guide', 'admin', '2023-06-30 11:55:17', 'admin', '2023-07-07 15:46:28', '若依官网地址'),
(100, '用户管理', 1, 1, 'user', 'system/user/index', '', 1, 0, 'C', '0', '0', 'system:user:list', 'user', 'admin', '2023-06-30 11:55:17', '', NULL, '用户管理菜单'),
(101, '角色管理', 1, 2, 'role', 'system/role/index', '', 1, 0, 'C', '0', '0', 'system:role:list', 'peoples', 'admin', '2023-06-30 11:55:17', '', NULL, '角色管理菜单'),
(102, '菜单管理', 1, 3, 'menu', 'system/menu/index', '', 1, 0, 'C', '0', '0', 'system:menu:list', 'tree-table', 'admin', '2023-06-30 11:55:17', '', NULL, '菜单管理菜单'),
(103, '部门管理', 1, 4, 'dept', 'system/dept/index', '', 1, 0, 'C', '0', '0', 'system:dept:list', 'tree', 'admin', '2023-06-30 11:55:17', '', NULL, '部门管理菜单'),
(104, '岗位管理', 1, 5, 'post', 'system/post/index', '', 1, 0, 'C', '0', '0', 'system:post:list', 'post', 'admin', '2023-06-30 11:55:17', '', NULL, '岗位管理菜单'),
(105, '字典管理', 1, 6, 'dict', 'system/dict/index', '', 1, 0, 'C', '0', '0', 'system:dict:list', 'dict', 'admin', '2023-06-30 11:55:17', '', NULL, '字典管理菜单'),
(106, '参数设置', 1, 7, 'config', 'system/config/index', '', 1, 0, 'C', '0', '0', 'system:config:list', 'edit', 'admin', '2023-06-30 11:55:17', '', NULL, '参数设置菜单'),
(107, '通知公告', 1, 8, 'notice', 'system/notice/index', '', 1, 0, 'C', '0', '0', 'system:notice:list', 'message', 'admin', '2023-06-30 11:55:17', '', NULL, '通知公告菜单'),
(108, '日志管理', 1, 9, 'log', '', '', 1, 0, 'M', '0', '0', '', 'log', 'admin', '2023-06-30 11:55:17', '', NULL, '日志管理菜单'),
(109, '在线用户', 2, 1, 'online', 'monitor/online/index', '', 1, 0, 'C', '0', '0', 'monitor:online:list', 'online', 'admin', '2023-06-30 11:55:17', '', NULL, '在线用户菜单'),
(110, '定时任务', 2, 2, 'job', 'monitor/job/index', '', 1, 0, 'C', '0', '0', 'monitor:job:list', 'job', 'admin', '2023-06-30 11:55:17', '', NULL, '定时任务菜单'),
(111, '数据监控', 2, 3, 'druid', 'monitor/druid/index', '', 1, 0, 'C', '0', '0', 'monitor:druid:list', 'druid', 'admin', '2023-06-30 11:55:17', '', NULL, '数据监控菜单'),
(112, '服务监控', 2, 4, 'server', 'monitor/server/index', '', 1, 0, 'C', '0', '0', 'monitor:server:list', 'server', 'admin', '2023-06-30 11:55:17', '', NULL, '服务监控菜单'),
(113, '缓存监控', 2, 5, 'cache', 'monitor/cache/index', '', 1, 0, 'C', '0', '0', 'monitor:cache:list', 'redis', 'admin', '2023-06-30 11:55:17', '', NULL, '缓存监控菜单'),
(114, '缓存列表', 2, 6, 'cacheList', 'monitor/cache/list', '', 1, 0, 'C', '0', '0', 'monitor:cache:list', 'redis-list', 'admin', '2023-06-30 11:55:17', '', NULL, '缓存列表菜单'),
(115, '表单构建', 3, 1, 'build', 'tool/build/index', '', 1, 0, 'C', '0', '0', 'tool:build:list', 'build', 'admin', '2023-06-30 11:55:17', '', NULL, '表单构建菜单'),
(116, '代码生成', 3, 2, 'gen', 'tool/gen/index', '', 1, 0, 'C', '0', '0', 'tool:gen:list', 'code', 'admin', '2023-06-30 11:55:17', '', NULL, '代码生成菜单'),
(117, '系统接口', 3, 3, 'swagger', 'tool/swagger/index', '', 1, 0, 'C', '0', '0', 'tool:swagger:list', 'swagger', 'admin', '2023-06-30 11:55:17', '', NULL, '系统接口菜单'),
(500, '操作日志', 108, 1, 'operlog', 'monitor/operlog/index', '', 1, 0, 'C', '0', '0', 'monitor:operlog:list', 'form', 'admin', '2023-06-30 11:55:17', '', NULL, '操作日志菜单'),
(501, '登录日志', 108, 2, 'logininfor', 'monitor/logininfor/index', '', 1, 0, 'C', '0', '0', 'monitor:logininfor:list', 'logininfor', 'admin', '2023-06-30 11:55:17', '', NULL, '登录日志菜单'),
(1000, '用户查询', 100, 1, '', '', '', 1, 0, 'F', '0', '0', 'system:user:query', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1001, '用户新增', 100, 2, '', '', '', 1, 0, 'F', '0', '0', 'system:user:add', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1002, '用户修改', 100, 3, '', '', '', 1, 0, 'F', '0', '0', 'system:user:edit', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1003, '用户删除', 100, 4, '', '', '', 1, 0, 'F', '0', '0', 'system:user:remove', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1004, '用户导出', 100, 5, '', '', '', 1, 0, 'F', '0', '0', 'system:user:export', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1005, '用户导入', 100, 6, '', '', '', 1, 0, 'F', '0', '0', 'system:user:import', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1006, '重置密码', 100, 7, '', '', '', 1, 0, 'F', '0', '0', 'system:user:resetPwd', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1007, '角色查询', 101, 1, '', '', '', 1, 0, 'F', '0', '0', 'system:role:query', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1008, '角色新增', 101, 2, '', '', '', 1, 0, 'F', '0', '0', 'system:role:add', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1009, '角色修改', 101, 3, '', '', '', 1, 0, 'F', '0', '0', 'system:role:edit', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1010, '角色删除', 101, 4, '', '', '', 1, 0, 'F', '0', '0', 'system:role:remove', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1011, '角色导出', 101, 5, '', '', '', 1, 0, 'F', '0', '0', 'system:role:export', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1012, '菜单查询', 102, 1, '', '', '', 1, 0, 'F', '0', '0', 'system:menu:query', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1013, '菜单新增', 102, 2, '', '', '', 1, 0, 'F', '0', '0', 'system:menu:add', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1014, '菜单修改', 102, 3, '', '', '', 1, 0, 'F', '0', '0', 'system:menu:edit', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1015, '菜单删除', 102, 4, '', '', '', 1, 0, 'F', '0', '0', 'system:menu:remove', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1016, '部门查询', 103, 1, '', '', '', 1, 0, 'F', '0', '0', 'system:dept:query', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1017, '部门新增', 103, 2, '', '', '', 1, 0, 'F', '0', '0', 'system:dept:add', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1018, '部门修改', 103, 3, '', '', '', 1, 0, 'F', '0', '0', 'system:dept:edit', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1019, '部门删除', 103, 4, '', '', '', 1, 0, 'F', '0', '0', 'system:dept:remove', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1020, '岗位查询', 104, 1, '', '', '', 1, 0, 'F', '0', '0', 'system:post:query', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1021, '岗位新增', 104, 2, '', '', '', 1, 0, 'F', '0', '0', 'system:post:add', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1022, '岗位修改', 104, 3, '', '', '', 1, 0, 'F', '0', '0', 'system:post:edit', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1023, '岗位删除', 104, 4, '', '', '', 1, 0, 'F', '0', '0', 'system:post:remove', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1024, '岗位导出', 104, 5, '', '', '', 1, 0, 'F', '0', '0', 'system:post:export', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1025, '字典查询', 105, 1, '#', '', '', 1, 0, 'F', '0', '0', 'system:dict:query', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1026, '字典新增', 105, 2, '#', '', '', 1, 0, 'F', '0', '0', 'system:dict:add', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1027, '字典修改', 105, 3, '#', '', '', 1, 0, 'F', '0', '0', 'system:dict:edit', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1028, '字典删除', 105, 4, '#', '', '', 1, 0, 'F', '0', '0', 'system:dict:remove', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1029, '字典导出', 105, 5, '#', '', '', 1, 0, 'F', '0', '0', 'system:dict:export', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1030, '参数查询', 106, 1, '#', '', '', 1, 0, 'F', '0', '0', 'system:config:query', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1031, '参数新增', 106, 2, '#', '', '', 1, 0, 'F', '0', '0', 'system:config:add', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1032, '参数修改', 106, 3, '#', '', '', 1, 0, 'F', '0', '0', 'system:config:edit', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1033, '参数删除', 106, 4, '#', '', '', 1, 0, 'F', '0', '0', 'system:config:remove', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1034, '参数导出', 106, 5, '#', '', '', 1, 0, 'F', '0', '0', 'system:config:export', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1035, '公告查询', 107, 1, '#', '', '', 1, 0, 'F', '0', '0', 'system:notice:query', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1036, '公告新增', 107, 2, '#', '', '', 1, 0, 'F', '0', '0', 'system:notice:add', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1037, '公告修改', 107, 3, '#', '', '', 1, 0, 'F', '0', '0', 'system:notice:edit', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1038, '公告删除', 107, 4, '#', '', '', 1, 0, 'F', '0', '0', 'system:notice:remove', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1039, '操作查询', 500, 1, '#', '', '', 1, 0, 'F', '0', '0', 'monitor:operlog:query', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1040, '操作删除', 500, 2, '#', '', '', 1, 0, 'F', '0', '0', 'monitor:operlog:remove', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1041, '日志导出', 500, 3, '#', '', '', 1, 0, 'F', '0', '0', 'monitor:operlog:export', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1042, '登录查询', 501, 1, '#', '', '', 1, 0, 'F', '0', '0', 'monitor:logininfor:query', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1043, '登录删除', 501, 2, '#', '', '', 1, 0, 'F', '0', '0', 'monitor:logininfor:remove', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1044, '日志导出', 501, 3, '#', '', '', 1, 0, 'F', '0', '0', 'monitor:logininfor:export', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1045, '账户解锁', 501, 4, '#', '', '', 1, 0, 'F', '0', '0', 'monitor:logininfor:unlock', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1046, '在线查询', 109, 1, '#', '', '', 1, 0, 'F', '0', '0', 'monitor:online:query', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1047, '批量强退', 109, 2, '#', '', '', 1, 0, 'F', '0', '0', 'monitor:online:batchLogout', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1048, '单条强退', 109, 3, '#', '', '', 1, 0, 'F', '0', '0', 'monitor:online:forceLogout', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1049, '任务查询', 110, 1, '#', '', '', 1, 0, 'F', '0', '0', 'monitor:job:query', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1050, '任务新增', 110, 2, '#', '', '', 1, 0, 'F', '0', '0', 'monitor:job:add', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1051, '任务修改', 110, 3, '#', '', '', 1, 0, 'F', '0', '0', 'monitor:job:edit', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1052, '任务删除', 110, 4, '#', '', '', 1, 0, 'F', '0', '0', 'monitor:job:remove', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1053, '状态修改', 110, 5, '#', '', '', 1, 0, 'F', '0', '0', 'monitor:job:changeStatus', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1054, '任务导出', 110, 6, '#', '', '', 1, 0, 'F', '0', '0', 'monitor:job:export', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1055, '生成查询', 116, 1, '#', '', '', 1, 0, 'F', '0', '0', 'tool:gen:query', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1056, '生成修改', 116, 2, '#', '', '', 1, 0, 'F', '0', '0', 'tool:gen:edit', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1057, '生成删除', 116, 3, '#', '', '', 1, 0, 'F', '0', '0', 'tool:gen:remove', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1058, '导入代码', 116, 4, '#', '', '', 1, 0, 'F', '0', '0', 'tool:gen:import', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1059, '预览代码', 116, 5, '#', '', '', 1, 0, 'F', '0', '0', 'tool:gen:preview', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(1060, '生成代码', 116, 6, '#', '', '', 1, 0, 'F', '0', '0', 'tool:gen:code', '#', 'admin', '2023-06-30 11:55:17', '', NULL, ''),
(2001, 'Demo', 1, 10, 'demo', 'system/demo/index', NULL, 1, 0, 'M', '0', '0', NULL, '404', 'admin', '2023-07-05 17:55:14', '', NULL, ''),
(2002, '教师界面', 3, 1, 'stu_wk', 'ruoyi-stu_wk/stu_wk/index', NULL, 1, 0, 'C', '0', '0', 'ruoyi-stu_wk:stu_wk:list', '#', 'admin', '2023-07-07 12:39:40', '', NULL, '教师界面菜单'),
(2003, '教师界面查询', 2002, 1, '#', '', '', 1, 0, 'F', '0', '0', 'ruoyi-stu_wk:stu_wk:query', '#', 'admin', '2023-07-07 12:39:40', '', NULL, ''),
(2004, '教师界面新增', 2002, 2, '#', '', '', 1, 0, 'F', '0', '0', 'ruoyi-stu_wk:stu_wk:add', '#', 'admin', '2023-07-07 12:39:40', '', NULL, ''),
(2005, '教师界面修改', 2002, 3, '#', '', '', 1, 0, 'F', '0', '0', 'ruoyi-stu_wk:stu_wk:edit', '#', 'admin', '2023-07-07 12:39:40', '', NULL, ''),
(2006, '教师界面删除', 2002, 4, '#', '', '', 1, 0, 'F', '0', '0', 'ruoyi-stu_wk:stu_wk:remove', '#', 'admin', '2023-07-07 12:39:40', '', NULL, ''),
(2007, '教师界面导出', 2002, 5, '#', '', '', 1, 0, 'F', '0', '0', 'ruoyi-stu_wk:stu_wk:export', '#', 'admin', '2023-07-07 12:39:40', '', NULL, ''),
(2008, '任务管理', 0, 4, 'scd', NULL, NULL, 1, 0, 'M', '0', '0', '', 'dict', 'admin', '2023-07-07 15:43:09', 'admin', '2023-07-07 15:46:03', ''),
(2009, '教师任务管理', 2008, 1, 'teacher', 'scd/teacher/index', NULL, 1, 0, 'C', '0', '0', 'scd:task:list', 'education', 'admin', '2023-07-07 15:44:28', 'admin', '2023-07-07 15:46:09', ''),
(2010, '我的任务', 2008, 2, 'student', 'scd/student/index', NULL, 1, 0, 'C', '0', '0', 'scd:task:list', 'excel', 'admin', '2023-07-07 19:20:33', '', NULL, '');
...
VALUES
     (1, '温馨提醒：2018-07-01 若依新版本发布啦', '2', _binary '新版本内容', '0', 'admin', '2023-06-30 11:55:17', '', NULL, '管理员'),
     (2, '维护通知：2018-07-01 若依系统凌晨维护', '1', _binary '维护内容', '0', 'admin', '2023-06-30 11:55:17', '', NULL, '管理员');
...
VALUES
    (1,'ceo','董事长',1,'0','admin','2023-06-30 11:55:16','',NULL,''),
    (2,'se','项目经理',2,'0','admin','2023-06-30 11:55:16','',NULL,''),
    (3,'hr','人力资源',3,'0','admin','2023-06-30 11:55:16','',NULL,''),
    (4,'user','普通员工',4,'0','admin','2023-06-30 11:55:16','',NULL,'');
...
VALUES
    (1,'超级管理员','admin',1,'1',1,1,'0','0','admin','2023-06-30 11:55:17','',NULL,'超级管理员'),
    (2,'普通角色','common',2,'2',1,1,'0','0','admin','2023-06-30 11:55:17','',NULL,'普通角色'),
    (100,'教师','teacher',3,'1',1,1,'0','0','admin','2023-07-01 11:13:43','admin','2023-07-01 11:14:43',NULL),
    (101,'学生','student',4,'1',1,1,'0','0','admin','2023-07-01 11:15:06','',NULL,NULL);
...
VALUES
    (2,1),(2,2),(2,3),(2,4),(2,100),(2,101),(2,102),(2,103),(2,104),(2,105),(2,106),(2,107),(2,108),(2,109),(2,110),(2,111),(2,112),(2,113),(2,114),(2,115),
    (2,116),(2,117),(2,500),(2,501),(2,1000),(2,1001),(2,1002),(2,1003),(2,1004),(2,1005),(2,1006),(2,1007),(2,1008),(2,1009),(2,1010),(2,1011),(2,1012),
    (2,1013),(2,1014),(2,1015),(2,1016),(2,1017),(2,1018),(2,1019),(2,1020),(2,1021),(2,1022),(2,1023),(2,1024),(2,1025),(2,1026),(2,1027),(2,1028),(2,1029),
    (2,1030),(2,1031),(2,1032),(2,1033),(2,1034),(2,1035),(2,1036),(2,1037),(2,1038),(2,1039),(2,1040),(2,1041),(2,1042),(2,1043),(2,1044),(2,1045),(2,1046),
    (2,1047),(2,1048),(2,1049),(2,1050),(2,1051),(2,1052),(2,1053),(2,1054),(2,1055),(2,1056),(2,1057),(2,1058),(2,1059),(2,1060),(100,2),(100,4),(100,109),
    (100,110),(100,111),(100,112),(100,113),(100,114),(100,1046),(100,1049),(100,1050),(100,1051),(100,1052),(100,1053),(100,1054),(101,4);
...
VALUES
    (1,103,'admin','若依','00','ry@163.com','15888888888','1','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','0','0','127.0.0.1','2023-07-07 21:31:56','admin','2023-06-30 11:55:16','','2023-07-07 21:31:55','管理员'),
    (2,105,'ry','若依','00','ry@qq.com','15666666666','1','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','0','0','127.0.0.1','2023-06-30 11:55:16','admin','2023-06-30 11:55:16','',NULL,'测试员'),
    (100,100,'zhangsan','张三','00','','','0','','$2a$10$V3OeQtoTiRF/jrO7zXJtTOJavYpA3Jg4/rcqVNvklczzEeBPGj1NS','0','0','',NULL,'admin','2023-07-07 13:36:31','',NULL,NULL),
    (101,100,'brz','brz','00','','','0','','$2a$10$prIOi8Ia7OgR6etJi2924.WSQrlYyBxha8S9u31sHgDANECYIa/FC','0','0','',NULL,'admin','2023-07-07 13:36:46','',NULL,NULL),
    (102,100,'bingbing','bingbing','00','','','0','','$2a$10$h5/R8BxPdOlVQD73HHQyTeZI9TXB0n04MJd4XWmTXTSvC/3bu6oIu','0','0','',NULL,'admin','2023-07-07 13:37:01','',NULL,NULL),
    (103,100,'wangtao','王涛','00','','','0','','$2a$10$QWrHp9s3BB.fdFayo3mx5OVqlEjRmLgFx/xWfmEzcJbY1JV0cVWI.','0','0','',NULL,'admin','2023-07-07 13:37:37','',NULL,NULL),
    (104,100,'maobo','毛博','00','','','0','','$2a$10$XKAtdGzSOV3tjuKsbxah3u99AFuHJtIb2/BDR60UKB2G9XpXNT.wa','0','0','127.0.0.1','2023-07-07 14:23:38','admin','2023-07-07 13:38:23','','2023-07-07 14:23:38',NULL),
    (105,100,'stu_a','学生A','00','','','0','','$2a$10$JiV0uiF7QvELjfBbGw/Dw.pygNJoWj6bCVtAnqyvZjZEoyQ4E2w8e','0','0','',NULL,'admin','2023-07-07 17:39:09','',NULL,NULL),
    (106,100,'stu_b','学生B','00','','','0','','$2a$10$MLoZXet7KAoj.uOHhybZaOzNxIX7gHlIG4AasSTLsz.ndhImanBrO','0','0','',NULL,'admin','2023-07-07 17:39:31','',NULL,NULL),
    (107,100,'stu_c','学生C','00','','','0','','$2a$10$UQJwXfGaGM0eOKBW/Uh/1eG7emhP/qBpAw/rH0u.yeaqHYx4c14Qm','0','0','',NULL,'admin','2023-07-07 17:39:41','',NULL,NULL),
    (108,100,'stu_d','学生D','00','','','0','','$2a$10$hzR5Hd5QcDjAm/FBtOC1oevLO6fK4rX4jFlMkOoaJz/F9ceLwL2QG','0','0','',NULL,'admin','2023-07-07 17:39:58','',NULL,NULL);
